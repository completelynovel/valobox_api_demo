...
(function() {
  ...
  valobox.bind('ready', function() {
    return valobox.widget('#valobox-reader').bind('ready', function(widget) {
      var menu,
        _this = this;
      menu = $('ul#menu');
      widget.bind('notify', function(event, args) {
        var pageIndex;
        if (args['pageIndex']) {
          pageIndex = parseInt(args['pageIndex']);
          menu.find('li').removeClass("active");
          return $.each(menu.find('li'), function(idx, item) {
            var chapterPageIndex, endPageIndex, l;
            item = $(item);
            l = item.children("a");
            chapterPageIndex = parseInt(l.attr('start_page'));
            endPageIndex = parseInt(l.attr('end_page'));
            if ((chapterPageIndex <= pageIndex && pageIndex < endPageIndex) || chapterPageIndex === pageIndex) {
      ...
      menu.find('a').bind('click', function(event) {
        ...
        return widget.jumpTo(pageIndex);
      });
      $("a.prev-page").click(function(e) {
        return widget.pageUp();
      });
      return $("a.next-page").click(function(e) {
        return widget.pageDown();
      });
    });
  });
